...
| 공통 할인 / 조건부(카드사·결제수단) 할인 구분 | ✅ 동작. 실구매가·최저가는 누구나 받는 쿠폰 할인만 반영하고, G마켓/옥션의 카드·결제수단 즉시할인은 `conditionalDiscount`로 따로 표시. 조건부 할인으로 공통 최저가보다 싸지는 판매처는 `lowestConditionalPrice`로 안내 |
